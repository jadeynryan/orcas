---
title: "Web Scraping & Mapping <br>Orca Encounters"
...
595 orca encounters = 595 separate webpages to scrape!
:::
:::

## Webscrape with {rvest}

-   Read webpage with `read_html()`
-   Extract specific parts with `html_elements()`
    -   `html_elements()` vs `html_elements()`
...
Scrape landing page to get links to encounter webpages
...
```{r}
#| output-location: fragment
orcas::make_encounter_df(years = 2022:2023, max_urls = 1)
```
...
-   Continue to clean data set (finding/fixing typos and blanks)
...
-   John Little [case study](https://www.youtube.com/watch?v=8ISc8V9GDAg)
